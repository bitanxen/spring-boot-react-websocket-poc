        ...
        <div className="bg-white pt-20 md:rounded-12 sm:mx-auto sm:w-full sm:max-w-xs">
          <div className="mb-20 sm:mx-auto sm:w-full sm:max-w-md">
            <img
              ...
              alt="Workflow"
            />
            <h2 className="mt-6 text-center text-lg leading-9 font-extrabold text-gray-900">
            ...
            >
              ...
              <div className="mt-6 flex items-center justify-between">
                <Link
                  ...
                  className="font-hairline text-indigo-600 hover:text-indigo-500 focus:outline-none focus:underline transition ease-in-out duration-150"
                >
              ...
              <div className="mt-6 grid grid-cols-3 gap-3">
                <div>
                  <span className="w-full inline-flex rounded-md shadow-sm">
                    <button
                      type="button"
                      className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md bg-white text-sm leading-5 font-medium text-gray-500 hover:text-blue-700 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue transition duration-150 ease-in-out"
                ...
                <div>
                  <span className="w-full inline-flex rounded-md shadow-sm">
                    <button
                      type="button"
                      className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md bg-white text-sm leading-5 font-medium text-gray-500 hover:text-black focus:outline-none focus:border-blue-300 focus:shadow-outline-blue transition duration-150 ease-in-out"
